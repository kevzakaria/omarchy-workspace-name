...
Panel {
  ...
  readonly property var presetIcons: [
    ...
    // The web, the things written down, and the tools a workspace is kept
    // open for. Checked the same way the rest were, by rendering each one in
    // the font: several obvious-looking codepoints are simply not in it and
    // draw nothing at all (0xF53F for a palette, 0xF544 for a robot, 0xF59F
    // and 0xF6FF), and 0xF466 is a muted speaker rather than a box.
